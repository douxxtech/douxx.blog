...
<head>
    ...
    <link href="assets/css/vars.css?13" rel="stylesheet">
    <link href="assets/css/base.css?13" rel="stylesheet">
    <link href="assets/css/layout.css?13" rel="stylesheet">
    <link href="assets/css/content.css?13" rel="stylesheet">
    <link href="assets/css/modes.css?13" rel="stylesheet">
    <link href="assets/css/navigation.css?13" rel="stylesheet">
    <link href="assets/css/responsive.css?13" rel="stylesheet">
</head>
...
<body>
    ...
    <script src="assets/js/config.js?13"></script>
    <script src="assets/js/renderer.js?13"></script>
    <script src="assets/js/sidebar.js?13"></script>
    <script src="assets/js/navigation.js?13"></script>
    <script src="assets/js/progressbar.js?13"></script>
    <script src="assets/js/giscus.js?13"></script>
    <script src="assets/js/loader.js?13"></script>
    <script src="assets/js/toggles.js?13"></script>
    <script src="assets/js/external-links.js?13"></script>
</body>
